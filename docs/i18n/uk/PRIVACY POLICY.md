...
Щоб допомогти нам покращити продукт, «Програмне забезпечення» може надсилати **анонімну статистику використання**. Ця функція повністю опціональна і **вимкнена за замовчуванням**: дані не надсилаються, доки ви явно її не увімкнете.
...
**Як увімкнути:**
Це добровільна згода. Встановіть `EXPERIENCE_IMPROVEMENT=true` у змінних середовища, щоб увімкнути збір; якщо змінна не задана (або дорівнює `false`), дані не надсилаються.
