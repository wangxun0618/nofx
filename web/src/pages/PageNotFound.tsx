            ...
            <div className="bg-nofx-bg-lighter border border-nofx-gold/20 p-8 rounded-lg max-w-md w-full relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col items-center gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="text-xs uppercase tracking-[0.3em] text-nofx-danger font-mono border-b border-nofx-danger/30 pb-2 inline-block">{t('notFound.signalLost', language)}</div>
                    </div>

                    <p className="text-sm text-nofx-text-muted font-mono leading-relaxed">{t('notFound.description', language)}</p>
                    ...
                    >
                        <Home size={16} />
                        <span>{t('notFound.returnBase', language)}</span>
